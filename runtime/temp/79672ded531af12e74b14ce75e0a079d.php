<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"F:\phpstudy_pro\WWW\match\public/../application/index\view\needknow\index.html";i:1585539868;s:64:"F:\phpstudy_pro\WWW\match\application\index\view\common\top.html";i:1585534730;s:69:"F:\phpstudy_pro\WWW\match\application\index\view\common\daojishi.html";i:1585539905;s:67:"F:\phpstudy_pro\WWW\match\application\index\view\common\footer.html";i:1585533024;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="page page-news-details">
      <!-- header -->
          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-sm-12 mt-bk">
              <div class="news-block white-block">
                <h3 class="t-c">报名需知</h3>
                <div class="mt-30">
                  <?php echo $content; ?>
                </div>
                <div class="t-c mt-50">
                  <a class="btn btn-primary" href="<?php echo url('index/index/bm'); ?>">下一步</a>
                </div>
              </div>
            </div>
            <!-- 倒计时/报名入口 -->
