...
<html lang="en">
  ...
  <script>
    ...
    $(".chaxun").on('click',function(){
      ...
      var code = $("#code").val();
      $.ajax({
        url:"<?php echo url('index/index/chaxun'); ?>",
        type: 'POST',
        dataType:"json",
        data: {
          'phone': phone,
