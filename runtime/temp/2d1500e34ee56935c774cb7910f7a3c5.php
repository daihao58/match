  ...
  <body>
    ...
    <section id="pageContainer" class="page-container">
        <div class="container">
                ...
                <div id="banner" class="banner swiper-container">
                  <ul class="swiper-wrapper">                
                    ...
                    <li class="swiper-slide">
                      <img class="banner-img" src="<?php echo $vo['imgurl']; ?>" />
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>

                  </ul>
                  <div id="bannerPager" class="swiper-pagination"></div>
                </div>
              </div>
            </div>
            <!-- 倒计时/报名入口 -->
          ...
          <!-- 视频 -->
          <ul class="video-block row">
            <?php if(is_array($videos) || $videos instanceof \think\Collection || $videos instanceof \think\Paginator): $i = 0; $__LIST__ = $videos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li class="col-lg-3 col-sm-6 mt-bk">
              <div class="video-item">
              <a class="btn-play-video iconfont icon-play" style="width:93%; height:97%; object-fit:fill">
                <video class="btn-play-video iconfont icon-play" style="width:100%; height:100%; object-fit:fill" controls>
                  <source src="<?php echo $vo['videourl']; ?>" type="video/ogg">
                </video>
              </a>
          ...
          <!-- 其他入口 -->
          <ul class="other-entrance-block row">
            <li class="col-lg-3 col-sm-6 mt-bk">
              <a href="<?php echo url('index/cases/saishi'); ?>" class="link-entrance link-entrance-ssgc">赛事规程</a>
            </li>
            <li class="col-lg-3 col-sm-6 mt-bk">
              <a href="<?php echo url('index/cases/newslist'); ?>" class="link-entrance link-entrance-bmxz">新闻媒体</a>
            </li>
            <li class="col-lg-3 col-sm-6 mt-bk">
              <a href="<?php echo url('us/index',['id'=>1]); ?>" class="link-entrance link-entrance-sshz">赛事合作</a>
            </li>
            <li class="col-lg-3 col-sm-6 mt-bk">
              <a href="<?php echo url('index/wonderful/index'); ?>" class="link-entrance link-entrance-jcsj">精彩瞬间</a>
            </li>
          </ul>
          <!-- 新闻列表 -->
          <div class="row">
            <!-- news -->
            <div class="col-lg-9 col-sm-12 mt-bk">
              <div class="news-block white-block">
                <div id="newsPager" class="tab-title">
                  <a class="btn-tab active">新闻公告</a>
                  <a class="btn-tab">活动公告</a>
                </div>
                <div id="newsTab" class="swiper-container mt-20">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <ul class="news-list">
                        <?php if(is_array($titles) || $titles instanceof \think\Collection || $titles instanceof \think\Paginator): $i = 0; $__LIST__ = $titles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          <li>
                            <a href="<?php echo url('index/cases/newsdetail',['id'=>$vo['id']]); ?>" class="news-link" value="<?php echo $vo['id']; ?>" ><?php echo $vo['title']; ?></a>
                          </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                      </ul>
                    </div>
                    <div class="swiper-slide">
                      ...
                      <?php if(is_array($activity) || $activity instanceof \think\Collection || $activity instanceof \think\Paginator): $i = 0; $__LIST__ = $activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li>
                          <a href="<?php echo url('index/cases/match',['id'=>$vo['id']]); ?>" class="news-link"><?php echo $vo['title']; ?></a>
                        </li>
                      <?php endforeach; endif; else: echo "" ;endif; ?>
                      </ul>
                    </div>
            ...
            <div class="col-lg-3 col-sm-12">
              <div class="row">
                <div class="col-lg-12 col-sm-6 mt-bk">
                  <a href="<?php echo url('index/needknow/index'); ?>" class="link-entrance mt-25">
                    <i class="iconfont icon-ticket"></i>
                    报名须知
                  </a>
              ...
              <!--  <div class="col-lg-12 col-sm-6">
                  <div class="black-block block-2 mt-bk"></div>
                  <div class="black-block block-2 mt-bk"></div>
                </div>-->
              </div>
            </div>
    ...
    <script>
      $(function() {
        ...
        $('#newsPager .btn-tab').on('click', function(e) {
          e.preventDefault()
